...
public class CalculadoraJOption {
    public static void main(String[] args) {
        ...
        switch(operacao){
            case "+":{
                JOptionPane.showMessageDialog(null, "O resultado da soma é:" + somar(num1, num2), "Resultado", 1);
                break;
            }
            case "-":{
            ...
            case "*":{
                JOptionPane.showMessageDialog(null, "O resultado da multiplicação  é:" + multiplicar(num1, num2), "Resultado", 1);
                break;
            }
            case "/":{
                JOptionPane.showMessageDialog(null, "O resultado da divisão é:" + dividir(num1, num2), "Resultado", 1);
                break;
            }
